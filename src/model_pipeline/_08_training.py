...
# run command
# python -m src.model_pipeline._08_training.py --train_path datasets/data-pipeline/06_preprocess_train_df.csv --preprocessor_path artifacts/model_v1/preprocessor.pkl --best_params_path artifacts/model_v1/tuning_metadata.json
